...
<div class="tblight-wrap">
	...
	<form method="post" name="admin-form" id="admin-form" class="admin-form validate">
		...
		<div class="form-group clearfix defaultcountry_form_field">
			...
			<div>
				<?php echo wp_kses( SelectList::getCountryOptions( 'configdata[default_country]', 'default_country', $data->default_country ), $allowedHtml ); ?>
			</div>			
		</div>
		...
		<a href="<?php echo esc_url(admin_url( 'admin.php?page=configs' )); ?>" class="button" data-action="back"><?php esc_attr_e( 'Cancel', 'cab-fare-calculator' ); ?></a>
	</form>
