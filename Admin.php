...
class TBLight_Admin {
	...
	public function screen_option() {
		...
		if ( !empty( $_REQUEST['page'] ) && $_REQUEST['page'] == 'cars' ) {
			add_screen_option( $option, $args );
			$this->cars_obj = new Cars_List();
		}
		if ( !empty( $_REQUEST['page'] ) && $_REQUEST['page'] == 'paymentmethods' ) {
			add_screen_option( $option, $args );
			$this->paymentmethods_obj = new Paymentmethods_List();
		}
		if ( !empty( $_REQUEST['page'] ) && $_REQUEST['page'] == 'configs' ) {
			$this->configs_obj = new Configs_List();
		}
		if ( !empty( $_REQUEST['page'] ) && $_REQUEST['page'] == 'orders' ) {
			add_screen_option( $option, $args );
