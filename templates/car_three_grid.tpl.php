	...
	<div class="vehicles-item-i">
		...
		<div class="vehicle-room">
			...
			<div class="vehicle-img">
				<?php echo wp_kses( $image, $allowedHtml ); ?>
				<?php
				if ( $car->text != '' ) {
					echo '<br><a href="javascript:void(0);" class="car_desc" title="' . esc_attr( $car->text ) . '">Vehicle Description</a>';
				}
				?>
			</div>
		...
		<div class="vehicle-price-outer">
			<div class="vehicle-price">
				...
				if ( $is_admin && $elsettings->debug_price_calculation == 1 ) {
					...
					//echo wp_kses( $price_debug_html, array( 'br' => array(), 'a' => array( 'href' => true, 'class' => true, 'data-title' => true, 'data-target-selector' => true ), 'div' => array( 'class' => true, 'style' => true) ) );
				}
				?>
